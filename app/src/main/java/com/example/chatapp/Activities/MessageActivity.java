...
import com.example.chatapp.Networking.APIService;
...
public class MessageActivity extends AppCompatActivity {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    Data data = new Data(firebaseUser.getUid(), R.mipmap.icon, username + " : " + message, "New Message"
                            , userid);
    ...
    private void currentUser(String userdid){
        SharedPreferences.Editor editor=getSharedPreferences("PREFS",MODE_PRIVATE).edit();
        editor.putString("currentuser",userdid);
        editor.apply();
    }
